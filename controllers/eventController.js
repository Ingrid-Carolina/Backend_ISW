...
export default class eventController {
  ...
  static async registrarEvento(req, res) {
    ...
    `;
      ...
      if (exito) return res.status(201).send({ mensaje, id });   // 201
  ...
  // listar (sin cambios funcionales)
  ...
  static async actualizarEvento(req, res) {
    ...
    `;
      ...
      return res.status(500).send({ mensaje: "Error al actualizar el evento", detalle: error.message });
    }
  }
}